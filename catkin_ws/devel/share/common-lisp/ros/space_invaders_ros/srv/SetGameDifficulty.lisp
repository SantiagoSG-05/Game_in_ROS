...
(cl:defmethod cl:initialize-instance :after ((m <SetGameDifficulty-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetGameDifficulty-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name space_invaders_ros-srv:<SetGameDifficulty-request> is deprecated: use space_invaders_ros-srv:SetGameDifficulty-request instead.")))
...
(cl:defmethod change_difficulty-val ((m <SetGameDifficulty-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader space_invaders_ros-srv:change_difficulty-val is deprecated.  Use space_invaders_ros-srv:change_difficulty instead.")
  (change_difficulty m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetGameDifficulty-request>)))
  ...
  "space_invaders_ros/SetGameDifficultyRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetGameDifficulty-request)))
  "Returns string type for a service object of type 'SetGameDifficulty-request"
  "space_invaders_ros/SetGameDifficultyRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <SetGameDifficulty-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetGameDifficulty-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name space_invaders_ros-srv:<SetGameDifficulty-response> is deprecated: use space_invaders_ros-srv:SetGameDifficulty-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <SetGameDifficulty-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader space_invaders_ros-srv:success-val is deprecated.  Use space_invaders_ros-srv:success instead.")
  (success m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetGameDifficulty-response>)))
  ...
  "space_invaders_ros/SetGameDifficultyResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetGameDifficulty-response)))
  "Returns string type for a service object of type 'SetGameDifficulty-response"
  "space_invaders_ros/SetGameDifficultyResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetGameDifficulty)))
  ...
  "space_invaders_ros/SetGameDifficulty")