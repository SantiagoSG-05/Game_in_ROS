...
(cl:in-package space_invaders_ros-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <user_msg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'user_msg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name space_invaders_ros-msg:<user_msg> is deprecated: use space_invaders_ros-msg:user_msg instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <user_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader space_invaders_ros-msg:name-val is deprecated.  Use space_invaders_ros-msg:name instead.")
  (name m))

(cl:ensure-generic-function 'username-val :lambda-list '(m))
(cl:defmethod username-val ((m <user_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader space_invaders_ros-msg:username-val is deprecated.  Use space_invaders_ros-msg:username instead.")
  (username m))

(cl:ensure-generic-function 'age-val :lambda-list '(m))
(cl:defmethod age-val ((m <user_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader space_invaders_ros-msg:age-val is deprecated.  Use space_invaders_ros-msg:age instead.")
  (age m))
